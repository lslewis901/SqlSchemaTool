...
namespace Lewis.SST.SQLObjects
{
    ...
    {
        /// <summary>
        /// static ssql statement
        /// </summary>
        public static string GetUDDTsList =
@"USE [{0}]
CREATE TABLE #temp1
(
...
";
        ...
        /// </summary>
        public static string GetTriggersSchema =
            @"USE [{0}]
EXEC sp_helptext '{1}'
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetTriggersList =
@"USE [{0}]
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetTableFileGroups =
    @"
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string ForceTableFileGroups =
@"
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetTableReferences =
            @"
SET @tablename = '{0}'
SET @flags = 0
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetSprocSchema =
    @"USE [{0}] 
EXEC sp_helptext '{1}'
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetSprocsList =
    @"
USE [{0}]
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetRulesSchema =
    @"USE [{0}]
EXEC sp_helptext '{1}'
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetFuncsList =
@" USE [{0}]
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetFuncSchema =
    @"USE [{0}] 
EXEC sp_helptext '{1}'
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetDefaultsList =
@"USE [{0}]
SELECT 
	DEFAULT_NAME = o.[name],
	USER_NAME = user_name(o.uid),
...
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetDefaultsSchema =
@"USE [{0}]
EXEC sp_helptext '{1}'
";
        ...
        /// static SQL statement
        /// </summary>
        public static string GetDTSPackagesList =
