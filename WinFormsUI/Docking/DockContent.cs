...
namespace WeifenLuo.WinFormsUI.Docking
{
	public class DockContent : Form, IDockContent
	{
        ...
        /// <returns></returns>
        public ArrayList ShowSaveFileDialog(string fileName, string saveDialogTitle, string filter, params object[] initialdir)
        {
            ...
            fd.InitialDirectory = initialdir != null && initialdir.Length > 0 ? initialdir[0].ToString() : Application.LocalUserAppDataPath;
        ...
        public ArrayList ShowOpenFileDialog(string fileName, string saveDialogTitle, string filter, params object[] initialdir)
        {
