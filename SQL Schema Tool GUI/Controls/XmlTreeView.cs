...
namespace Lewis.SST.Controls
{
    public class XmlTreeView : TreeView
    {
        ...
        private static Logger logger = LogManager.GetLogger("Lewis.SST.Controls");
        #endregion
        ...
        private bool IsThirdLevel(TreeNode node)
        {
        ...
        public void Open(string filename)
        {
            ...
            this.Navigator = document.CreateNavigator();
            _nsmgr = new XmlNamespaceManager(Navigator.NameTable);
        }
        ...
        protected override void OnDrawNode(DrawTreeNodeEventArgs e)
        {
            ...
            if ((e.State & TreeNodeStates.Selected) == TreeNodeStates.Selected)
            {
                ...
                TextRenderer.DrawText(e.Graphics, e.Node.Text, this.Font, bounds, foreColor, backColor, (TextFormatFlags)_stringFormat.FormatFlags);
            }
            else
            {
                this.DrawStrings(e.Node.Text, bounds, e.Graphics);
            }
