...
PREV ISSUE TRACKING: 
	...
	Status: Fixed. 02/12/2009
	Issue: Compare of two XML files or XML vs SQL or SQL vs XML causes error with
		FileNames.  This was a problem in both commandline and GUI apps.

	Status: Fixed. 02/12/2009
	Issue: SQL Schema Generate from 2005 DB without functions fail, with Temp Table
		Error.

	Status: Fixed. 02/13/2009
	Issue: File Save As does not properly save the file of the current active document 
		after changing tabs.
